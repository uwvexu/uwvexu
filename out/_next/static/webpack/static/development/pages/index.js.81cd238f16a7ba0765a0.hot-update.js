...
})(["flex-shrink:0;min-width:100%;min-height:100%;background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";:hover{transition:all 0.9s;background-color:rgba(211,177,0,0.85);background-blend-mode:darken;}"], function (props) {
  return props.src;
}, function (props) {
...
//# sourceMappingURL=index.js.81cd238f16a7ba0765a0.hot-update.js.map