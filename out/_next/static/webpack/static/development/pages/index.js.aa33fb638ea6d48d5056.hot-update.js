...
})(["flex-shrink:0;min-width:100%;min-height:100%;transition:all 0.5s;background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";background-color:rgba(211,177,0,0);background-blend-mode:color;:hover{background-color:rgba(211,177,0,0.8);}"], function (props) {
  return props.src;
}, function (props) {
...
//# sourceMappingURL=index.js.aa33fb638ea6d48d5056.hot-update.js.map