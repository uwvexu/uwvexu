...
})(["flex-shrink:0;min-width:100%;min-height:100%;transition:all 0.5s;background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";:hover{background-color:rgba(211,177,0,0.8);background-blend-mode:darken;}"], function (props) {
  return props.src;
}, function (props) {
...
//# sourceMappingURL=index.js.45aecdb079ea463ddb85.hot-update.js.map