...
})(["flex-shrink:0;min-width:100%;min-height:100%;background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";background-color:rgba(0,0,0,0.85);:hover{transition:all 0.2s;background-color:rgba(211,177,0,0.85);}"], function (props) {
  return props.src;
}, function (props) {
...
//# sourceMappingURL=index.js.9a783022c23aa5028a9b.hot-update.js.map