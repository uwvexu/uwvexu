...
})(["flex-shrink:0;min-width:100%;min-height:100%;transition:all 0.5s;background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";background-color:rgba(211,177,0,0);:hover{background-color:rgba(211,177,0,0.8);background-blend-mode:color;}"], function (props) {
  return props.src;
}, function (props) {
...
//# sourceMappingURL=index.js.26fc84de70d121a77a0f.hot-update.js.map