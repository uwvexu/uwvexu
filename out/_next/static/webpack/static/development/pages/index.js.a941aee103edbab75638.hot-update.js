...
})(["flex-shrink:0;min-width:100%;min-height:100%;transition:all 0.5s;background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";background-color:rgba(211,177,0,0);background-blend-mode:darken;:hover{background-color:rgba(211,177,0,0.8);}"], function (props) {
  return props.src;
}, function (props) {
...
})(["width:100%;height:100%;display:none;position:absolute;top:0px;left:0px;:hover{display:block;background-color:black;opacity:0.75;}"]);
...
//# sourceMappingURL=index.js.a941aee103edbab75638.hot-update.js.map