...
})(["flex-shrink:0;min-width:100%;min-height:100%;transition:all 0.5s;filter:grayscale(100%);background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";:hover{background-color:rgba(211,177,0,0.85);background-blend-mode:darken;}"], function (props) {
  return props.src;
}, function (props) {
...
//# sourceMappingURL=index.js.eb24c9c7ab57c37ad5f5.hot-update.js.map