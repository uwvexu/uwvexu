...
})(["flex-shrink:0;min-width:100%;min-height:100%;transition:all 0.5s;background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";background-color:rgba(211,177,0,0);background-blend-mode:darken;:hover{}"], function (props) {
  return props.src;
}, function (props) {
...
})(["width:100%;height:100%;display:none;position:absolute;top:0px;left:0px;z-index:1;:hover{display:block;background-color:black;opacity:0.75;}"]);
...
//# sourceMappingURL=index.js.f8104581ee77c81298a6.hot-update.js.map