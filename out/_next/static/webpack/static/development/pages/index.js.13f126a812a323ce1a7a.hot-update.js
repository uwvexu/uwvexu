...
})(["flex-shrink:0;min-width:100%;min-height:100%;background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";background-color:rgba(211,177,0,0.85);:hover{transition:all 0.2s;background-color:rgba(211,177,0,0.85);}"], function (props) {
  return props.src;
}, function (props) {
...
//# sourceMappingURL=index.js.13f126a812a323ce1a7a.hot-update.js.map