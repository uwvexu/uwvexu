...
})(["display:flex;flex-direction:row;padding-top:1rem;justify-content:", ";*{flex:1;}> *:not(:first-child){margin-left:1rem;> button{justify-content:flex-end;}@media (max-width:", "px){display:block;}@media (max-width:576px){>:nth-child(2){display:none;}}}"], function (props) {
  return props.end ? "flex-end" : "flex-start";
}, _Styles__WEBPACK_IMPORTED_MODULE_2__["responsiveSizes"].smallScreen);
...
//# sourceMappingURL=index.js.1117013a13db7dfb81e4.hot-update.js.map