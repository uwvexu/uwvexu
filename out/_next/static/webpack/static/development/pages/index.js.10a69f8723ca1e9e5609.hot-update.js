...
})(["flex-shrink:0;min-width:100%;min-height:100%;background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:", ";&:hover{transition:all 0.2s;background-color:rgba(0,0,0,0.85);}"], function (props) {
  return props.src;
}, function (props) {
...
//# sourceMappingURL=index.js.10a69f8723ca1e9e5609.hot-update.js.map